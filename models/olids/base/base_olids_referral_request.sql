...
SELECT
    ...
    src."unique_booking_reference_number" AS unique_booking_reference_number,
    src."clinical_effective_date" AS clinical_effective_date,
    src."date_precision_concept_id" AS date_precision_concept_id,
    src."requester_organisation_id" AS requester_organisation_id,
    src."recipient_organisation_id" AS recipient_organisation_id,
    src."referral_request_priority_concept_id" AS referral_request_priority_concept_id,
    src."referral_request_type_concept_id" AS referral_request_type_concept_id,
    src."referral_request_specialty_concept_id" AS referral_request_specialty_concept_id,
    src."mode" AS mode,
    src."is_outgoing_referral" AS is_outgoing_referral,
    src."is_review" AS is_review,
    src."referral_request_source_concept_id" AS referral_request_source_concept_id,
