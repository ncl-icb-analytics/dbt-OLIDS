CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.INTERMEDIATE_DEPRESSION_DETAILS (
    ...
    RAW_LATEST_DEPRESSION_RESOLVED_DATE DATE, -- Latest DEPRES_COD date, regardless of DEPR_COD dates
...
SELECT
    ...
    MAX(CASE WHEN bo.CLUSTER_ID = 'DEPRES_COD' THEN bo.CLINICAL_EFFECTIVE_DATE END) AS RAW_LATEST_DEPRESSION_RESOLVED_DATE,
