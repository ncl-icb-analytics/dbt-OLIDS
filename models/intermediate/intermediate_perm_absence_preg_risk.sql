CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.INTERMEDIATE_PERM_ABSENCE_PREG_RISK (
    ...
    ALL_PERM_ABS_PREG_RISK_OBSERVATION_IDS ARRAY COMMENT 'Array of unique observation IDs related to these events',
    ...
    ALL_PERM_ABS_PREG_RISK_CODE_CATEGORIES_APPLIED ARRAY COMMENT 'Array of code categories applied (e.g., \'PREGRISK\') from the source codeset'
)
...
PersonLevelPermAbsPregRiskAggregation AS (
    ...
    SELECT
        ...
        ARRAY_AGG(DISTINCT OBSERVATION_ID) WITHIN GROUP (ORDER BY OBSERVATION_ID) AS ALL_PERM_ABS_PREG_RISK_OBSERVATION_IDS,
        ...
        ARRAY_AGG(DISTINCT CODE_CATEGORY) WITHIN GROUP (ORDER BY CODE_CATEGORY) AS ALL_PERM_ABS_PREG_RISK_CODE_CATEGORIES_APPLIED
...
SELECT
    ...
    pla.ALL_PERM_ABS_PREG_RISK_OBSERVATION_IDS,
    pla.ALL_PERM_ABS_PREG_RISK_CONCEPT_CODES,
    pla.ALL_PERM_ABS_PREG_RISK_CONCEPT_DISPLAYS,
    pla.ALL_PERM_ABS_PREG_RISK_CODE_CATEGORIES_APPLIED
