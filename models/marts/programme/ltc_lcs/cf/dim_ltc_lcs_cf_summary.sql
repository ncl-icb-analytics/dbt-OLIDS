...
-- AF joins
LEFT JOIN {{ ref('dim_ltc_lcs_cf_af_61') }} af_61 ON base.person_id = af_61.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_af_62') }} af_62 ON base.person_id = af_62.person_id

-- CKD joins
LEFT JOIN {{ ref('dim_ltc_lcs_cf_ckd_61') }} ckd_61 ON base.person_id = ckd_61.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_ckd_62') }} ckd_62 ON base.person_id = ckd_62.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_ckd_63') }} ckd_63 ON base.person_id = ckd_63.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_ckd_64') }} ckd_64 ON base.person_id = ckd_64.person_id

-- CVD joins
LEFT JOIN {{ ref('dim_ltc_lcs_cf_cvd_61') }} cvd_61 ON base.person_id = cvd_61.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_cvd_62') }} cvd_62 ON base.person_id = cvd_62.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_cvd_63') }} cvd_63 ON base.person_id = cvd_63.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_cvd_64') }} cvd_64 ON base.person_id = cvd_64.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_cvd_65') }} cvd_65 ON base.person_id = cvd_65.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_cvd_66') }} cvd_66 ON base.person_id = cvd_66.person_id

-- Diabetes joins
LEFT JOIN {{ ref('dim_ltc_lcs_cf_dm_61') }} dm_61 ON base.person_id = dm_61.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_dm_62') }} dm_62 ON base.person_id = dm_62.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_dm_63') }} dm_63 ON base.person_id = dm_63.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_dm_64') }} dm_64 ON base.person_id = dm_64.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_dm_65') }} dm_65 ON base.person_id = dm_65.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_dm_66') }} dm_66 ON base.person_id = dm_66.person_id

-- Hypertension joins
LEFT JOIN {{ ref('dim_ltc_lcs_cf_htn_61') }} htn_61 ON base.person_id = htn_61.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_htn_62') }} htn_62 ON base.person_id = htn_62.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_htn_63') }} htn_63 ON base.person_id = htn_63.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_htn_65') }} htn_65 ON base.person_id = htn_65.person_id
LEFT JOIN {{ ref('dim_ltc_lcs_cf_htn_66') }} htn_66 ON base.person_id = htn_66.person_id

-- CYP Asthma join
LEFT JOIN {{ ref('dim_ltc_lcs_cf_cyp_ast_61') }} cyp_ast_61 ON base.person_id = cyp_ast_61.person_id 