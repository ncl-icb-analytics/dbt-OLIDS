{{
    config(
        ...
        post_hook=[
            "COMMENT ON TABLE {{ this }} IS 'Dimension table providing the latest recorded care home/nursing home status for persons who have a recorded residence status. Only includes persons with CAREHOME_COD, NURSEHOME_COD, or TEMPCARHOME_COD records.'"
        ]
    )
}}
