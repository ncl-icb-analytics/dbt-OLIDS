{{
    config(
        ...
        post_hook=[
            "COMMENT ON TABLE {{ this }} IS 'Dimension table identifying individuals who are not male and are aged 55 or younger. Includes flags for standard child-bearing age ranges.'"
        ]
    )
}}
