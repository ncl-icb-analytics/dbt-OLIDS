CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.FCT_PERSON_DX_EPILEPSY (
...
LatestMedicationDetails AS (
    ...
    FROM DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.INTERMEDIATE_EPILEPSY_ORDERS_6M
    GROUP BY PERSON_ID
)
