CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_NHS_HEALTH_CHECK_STATUS (
    -- Identifiers
...
WITH LatestHealthCheck AS (
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_NHS_HEALTH_CHECK_LATEST
)
...
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PROG_NHS_HEALTH_CHECK_ELIGIBILITY d
