CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_SMI (
...
WITH FilteredByAge AS (
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_MH_DIAGNOSES mh
    FULL OUTER JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_LITHIUM_ORDERS li
