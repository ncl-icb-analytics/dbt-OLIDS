CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_LD (
...
WITH FilteredByAge AS (
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_LD_DIAGNOSES_ALL ld
...
PersonLevelLDAggregation AS (
    ...
    -- determining earliest/latest diagnosis dates and collecting concept details.
    SELECT
        PERSON_ID,
...
-- who have a learning disability diagnosis, along with concept details.
SELECT
    pla.PERSON_ID,
    pla.SK_PATIENT_ID,
    pla.AGE,
