CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_OBESITY (
...
WITH FilteredByAge AS (
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_BMI_QOF b
    FULL OUTER JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_ETHNICITY_QOF e
        ON b.PERSON_ID = e.PERSON_ID
    JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PERSON_AGE a
