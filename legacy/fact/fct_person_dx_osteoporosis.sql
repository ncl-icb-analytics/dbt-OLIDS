CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.FCT_PERSON_DX_OSTEOPOROSIS (
...
WITH FilteredByAge AS (
    ...
    LEFT JOIN DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.INTERMEDIATE_OSTEOPOROSIS_DIAGNOSES AS O
        ON PP."person_id" = O.PERSON_ID
    LEFT JOIN DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.INTERMEDIATE_FRAGILITY_FRACTURES AS F
