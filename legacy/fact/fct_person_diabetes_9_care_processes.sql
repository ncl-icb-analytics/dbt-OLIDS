CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DIABETES_9_CARE_PROCESSES(
...
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DIABETES_8_CARE_PROCESSES eight
CROSS JOIN TwelveMonthsAgo t
LEFT JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_RETINAL_SCREENING_LATEST ret
