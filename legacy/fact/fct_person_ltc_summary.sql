CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_LTC_SUMMARY (
...
WITH ConditionUnion AS (
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_AF
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_ASTHMA
    ...
    SELECT
        ...
        EARLIEST_ASTHMA_DIAGNOSIS_DATE AS EARLIEST_DIAGNOSIS_DATE,
        LATEST_ASTHMA_DIAGNOSIS_DATE AS LATEST_DIAGNOSIS_DATE
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_CYP_ASTHMA
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_CANCER
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_CHD
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_CKD
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_COPD
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_DEMENTIA
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_DEPRESSION
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_EPILEPSY
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_HF
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_HYPERTENSION
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_LD
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_NAFLD
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_NDH
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_OBESITY
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_OSTEOPOROSIS
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_PALLIATIVE_CARE
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_PAD
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_RA
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_SMI
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_STIA
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_FHYP
    ...
    SELECT
        ...
        IS_ON_GEST_DIAB_REGISTER AS IS_ON_REGISTER,
        EARLIEST_GEST_DIAB_DIAGNOSIS_DATE AS EARLIEST_DIAGNOSIS_DATE,
        LATEST_GEST_DIAB_DIAGNOSIS_DATE AS LATEST_DIAGNOSIS_DATE
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_GESTATIONAL_DIABETES
)
SELECT
    cu.PERSON_ID,
    cu.SK_PATIENT_ID,
