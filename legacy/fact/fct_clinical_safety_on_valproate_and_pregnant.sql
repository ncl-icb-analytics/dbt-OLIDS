CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_CLINICAL_SAFETY_ON_VALPROATE_AND_PREGNANT (
    -- Core Identifiers
...
FROM
    DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PERSON_WOMEN_CHILD_BEARING_AGE wcba
JOIN
    DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_PREGNANT preg
    ON wcba.PERSON_ID = preg.PERSON_ID
JOIN
    DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_VALPROATE_ORDERS_6M_LATEST valp
