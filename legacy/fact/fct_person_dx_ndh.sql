CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_NDH (
...
WITH FilteredByAge AS (
    ...
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_NDH_DIAGNOSES ndh
    FULL OUTER JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_DIABETES_DIAGNOSES dm
