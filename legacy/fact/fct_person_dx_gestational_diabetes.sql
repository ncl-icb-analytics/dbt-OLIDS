CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_DX_GESTATIONAL_DIABETES (
...
LEFT JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_PREGNANT preg
