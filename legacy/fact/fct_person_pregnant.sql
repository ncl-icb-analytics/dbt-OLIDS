CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.FCT_PERSON_PREGNANT (
...
WITH BaseObservationsAndDemographics AS (
    ...
    JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PERSON_SEX sex_dim
        ON PP."person_id" = sex_dim.PERSON_ID
    JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PERSON_AGE age_dim
...
LEFT JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_PERM_ABSENCE_PREG_RISK perm_abs
