CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.REFERENCE.COMBINED_CODESETS (
    CLUSTER_ID,
    CLUSTER_DESCRIPTION,
    CODE,
    CODE_DESCRIPTION,
...
SELECT
    ...
    'PCD' AS source
FROM DATA_LAB_OLIDS_UAT.REFERENCE.pcd_refset_latest
UNION ALL
-- UKHSA COVID data
SELECT
    UPPER(CLUSTER_ID) AS cluster_id,
...
FROM DATA_LAB_OLIDS_UAT.REFERENCE.UKHSA_COVID_LATEST
UNION ALL
-- UKHSA FLU data
SELECT
    ...
    SNOMED_DESCRIPTION AS code_description,
    'UKHSA_FLU' AS source
FROM DATA_LAB_OLIDS_UAT.REFERENCE.UKHSA_FLU_LATEST
UNION ALL
-- LTC LCS CODES data
SELECT
    UPPER(CLUSTER_ID) AS cluster_id,
    ...
    SNOMED_DESCRIPTION AS code_description,
    'LTC_LCS' AS source
FROM DATA_LAB_OLIDS_UAT.REFERENCE.LTC_LCS_CODES;
