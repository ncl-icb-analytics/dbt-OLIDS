...
CREATE OR REPLACE TABLE DATA_LAB_OLIDS_UAT.REFERENCE.VALPROATE_PROG_CODES (
    ...
    -- Consider adding a primary key constraint if needed, e.g., PRIMARY KEY (CODE, CODE_CATEGORY)
)
COMMENT = 'Stores medical codes for the Valproate safety program, categorized by their purpose (ARAF Form, Pregnancy Risk Absence, Psychiatry, ARAF Referral).';
