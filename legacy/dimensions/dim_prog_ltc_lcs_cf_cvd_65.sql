CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PROG_LTC_LCS_CF_CVD_65 (
    PERSON_ID VARCHAR,
...
COMMENT = 'Dimension table for CVD 65 case finding indicator. Identifies patients with QRISK2 ≥ 10 who need moderate-dose statins (not on moderate-dose statins, no allergies, no decisions).'
TARGET_LAG = '4 hours'
REFRESH_MODE = AUTO
...
WITH QRISK2Readings AS (
    ...
    JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_LTC_LCS_CF_CVD_65_BASE b
...
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_LTC_LCS_CF_CVD_65_BASE b
