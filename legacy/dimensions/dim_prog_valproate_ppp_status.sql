CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PROG_VALPROATE_PPP_STATUS (
...
WITH BasePPPObservations AS (
    ...
    FROM
        DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_PPP_STATUS_ALL ppp
    JOIN
