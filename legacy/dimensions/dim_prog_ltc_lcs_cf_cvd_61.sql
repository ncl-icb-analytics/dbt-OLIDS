CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PROG_LTC_LCS_CF_CVD_61 (
    PERSON_ID VARCHAR,
...
COMMENT = 'Dimension table for LTC LCS case finding indicator CVD_61: Patients with QRISK2 score ≥ 20%. Only includes patients who meet all criteria from the base population.'
TARGET_LAG = '4 hours'
REFRESH_MODE = AUTO
...
SELECT
    ...
    bp.AGE,
    CASE
        WHEN qr.RESULT_VALUE >= 20 THEN TRUE
        ELSE FALSE
