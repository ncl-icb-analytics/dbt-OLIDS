CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PROG_VALPROATE_DB_SCOPE (
    -- Core Identifiers
...
JOIN DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PERSON_ACTIVE_PATIENTS ap
