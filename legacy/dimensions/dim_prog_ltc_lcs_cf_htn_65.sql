CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.DIM_PROG_LTC_LCS_CF_HTN_65 (
    PERSON_ID VARCHAR, -- Unique identifier for the person
    SK_PATIENT_ID VARCHAR, -- Surrogate key for the patient
    AGE NUMBER, -- Age of the patient
    HAS_STAGE_1_HYPERTENSION_RISK BOOLEAN, -- Flag indicating if person has stage 1 hypertension with risk factors
...
COMMENT = 'Dimension table for LTC LCS case finding indicator HTN_65: Patients with stage 1 hypertension who have additional risk factors:
...
HigherPriorityPatients AS (
    -- Get patients from higher priority groups (HTN_61, HTN_62, and HTN_63)
    SELECT DISTINCT PERSON_ID
    FROM (
        SELECT PERSON_ID
        ...
        SELECT PERSON_ID
        FROM DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.DIM_PROG_LTC_LCS_CF_HTN_63
...
SELECT
    ...
    CASE
        ...
        ELSE FALSE
    END AS HAS_STAGE_1_HYPERTENSION_RISK,
