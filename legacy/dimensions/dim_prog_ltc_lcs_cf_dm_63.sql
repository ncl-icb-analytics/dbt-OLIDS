CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PROG_LTC_LCS_CF_DM_63 (
    PERSON_ID VARCHAR, -- Unique identifier for the person
    SK_PATIENT_ID VARCHAR, -- Surrogate key for the patient
    AGE NUMBER, -- Age of the patient
    HAS_ELEVATED_HBA1C BOOLEAN, -- Flag indicating if person has HbA1c between 46-48 and no reading in last year
...
COMMENT = 'Dimension table for LTC LCS case finding indicator DM_63: Patients who meet ALL of the following criteria:
