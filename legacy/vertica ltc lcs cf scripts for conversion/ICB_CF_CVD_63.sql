...
OTHER AS (
    ...
    INNER JOIN NON_HDL_CHOL ON ICB_CF_CVD_63_BASE.EMPI_ID = NON_HDL_CHOL.EMPI_ID
...
EMIS AS (
    ...
    INNER JOIN
        NON_HDL_CHOL_EMIS
        ON ICB_CF_CVD_63_BASE.EMPI_ID = NON_HDL_CHOL_EMIS.EMPI_ID
    INNER JOIN STAT_COD_EMIS USING (EMPI_ID)
    WHERE
        RN = 1 AND NORM_NUMERIC_VALUE > 2.5
        AND SOURCE = 'EMIS'
)
