...
-- Diabetes
SELECT DISTINCT EMPI_ID, '' AS SOURCE_DESCRIPTION
...
SELECT DISTINCT Q.EMPI_ID, Q.SOURCE_DESCRIPTION

FROM  PH_F_QUESTIONNAIRE_QUESTION AS Q 
INNER JOIN  PH_F_QUESTIONNAIRE_ANSWER AS A ON Q.EMPI_ID = A.EMPI_ID AND Q.QUESTION_ID = A.QUESTION_ID
