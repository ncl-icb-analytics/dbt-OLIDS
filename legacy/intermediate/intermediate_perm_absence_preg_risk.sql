CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_PERM_ABSENCE_PREG_RISK (
...
WITH BasePermAbsPregRiskObservations AS (
    ...
    JOIN
        DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PERSON_AGE AS AGE_DIM
