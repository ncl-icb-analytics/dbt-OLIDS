...
COMMENT = 'Intermediate table containing epilepsy medication orders from the last 6 months. Filters based on EPILDRUG_COD cluster ID from MAPPED_CONCEPTS.'
TARGET_LAG = '4 hours'
REFRESH_MODE = AUTO
INITIALIZE = ON_CREATE
WAREHOUSE = NCL_ANALYTICS_XS
AS
WITH BaseEpilepsyOrders AS (
    -- Fetches medication orders for epilepsy medications (EPILDRUG_COD)
