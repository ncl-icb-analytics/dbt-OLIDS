CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_TOTAL_CHOLESTEROL_ALL(
...
JOIN DATA_LAB_OLIDS_UAT.REFERENCE.MAPPED_CONCEPTS c
