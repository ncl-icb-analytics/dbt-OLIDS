CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.INTERMEDIATE_ACE_INHIBITOR_ORDERS_ALL (
...
COMMENT = 'Intermediate table containing all ACE inhibitor medication orders (BNF section 2.5.5.1). Includes orders for Captopril, Enalapril, Lisinopril, Perindopril, Ramipril, and Trandolapril.'
TARGET_LAG = '4 hours'
REFRESH_MODE = AUTO
...
WITH BaseACEInhibitorOrders AS (
    ...
    WHERE bnf.BNF_CODE LIKE '02050501%' -- ACE inhibitors
),
OrderCounts AS (
