CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_TOTAL_CHOLESTEROL_LATEST(
...
SELECT
    ...
    CONCEPT_CODE,
    CODE_DESCRIPTION
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_TOTAL_CHOLESTEROL_ALL
