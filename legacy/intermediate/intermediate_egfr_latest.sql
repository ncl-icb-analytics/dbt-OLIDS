CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_EGFR_LATEST (
...
SELECT
    ...
    concept_code,
    code_description
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_EGFR_ALL -- Source from the intermediate table containing all eGFR results
