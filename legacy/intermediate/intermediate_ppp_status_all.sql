CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_PPP_STATUS_ALL (
...
JOIN DATA_LAB_OLIDS_UAT.REFERENCE.VALPROATE_PROG_CODES VPC
