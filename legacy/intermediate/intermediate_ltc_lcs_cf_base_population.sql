CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_LTC_LCS_CF_BASE_POPULATION (
    PERSON_ID,
    SK_PATIENT_ID,
    CONDITION_CODE,
    IS_ON_REGISTER
...
WHERE PERSON_ID NOT IN (
    ...
    SELECT PERSON_ID
    FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.DIM_PROG_LTC_LCS_CF_EXCLUSIONS
)
