CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_QRISK_LATEST(
...
SELECT
    ...
    CODE_DESCRIPTION,
    QRISK_TYPE
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_QRISK_ALL
