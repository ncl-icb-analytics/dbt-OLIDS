CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_FOOT_CHECK_LATEST (
...
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_FOOT_CHECK_ALL
