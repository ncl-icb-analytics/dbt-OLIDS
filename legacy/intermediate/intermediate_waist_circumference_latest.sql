CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_WAIST_CIRCUMFERENCE_LATEST (
...
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_WAIST_CIRCUMFERENCE_ALL
