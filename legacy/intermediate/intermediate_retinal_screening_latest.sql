CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.INTERMEDIATE_RETINAL_SCREENING_LATEST(
...
SELECT
    ...
    CONCEPT_CODE,
    CODE_DESCRIPTION
FROM DATA_LAB_NCL_TRAINING_TEMP.HEI_MIGRATION.INTERMEDIATE_RETINAL_SCREENING_ALL
