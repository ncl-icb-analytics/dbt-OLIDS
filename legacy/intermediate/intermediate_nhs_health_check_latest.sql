CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_NHS_HEALTH_CHECK_LATEST(
...
SELECT
    ...
    CONCEPT_CODE,
    CODE_DESCRIPTION
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_NHS_HEALTH_CHECK_ALL
