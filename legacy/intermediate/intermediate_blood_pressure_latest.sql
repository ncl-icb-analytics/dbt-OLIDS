CREATE OR REPLACE DYNAMIC TABLE DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_BLOOD_PRESSURE_LATEST(
...
SELECT
    ...
    IS_HOME_BP_EVENT,
    IS_ABPM_BP_EVENT
FROM DATA_LAB_OLIDS_UAT.HEI_MIGRATION.INTERMEDIATE_BLOOD_PRESSURE_ALL
