...
This project uses dbt to transform healthcare data in Snowflake, creating analytics-ready datasets for healthcare analysis, designed to run on the One London Integrated Data set, which contains data from GP practices in London.
