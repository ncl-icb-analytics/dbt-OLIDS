...
B.CLUSTER_ID = 'HTN_SYSTOLIC_1' AND 
L.CLUSTER_ID = 'HTN_SYSTOLIC_2' 
...
INNER JOIN JOINED_LTC_LOOKUP AS L ON B.RESULT_CODE = L.SNOMED_CODE 
WHERE SOURCE_DESCRIPTION = 'EMIS GP' AND 
B.CLUSTER_ID = 'HTN_DIASTOLIC_1' AND 
L.CLUSTER_ID = 'HTN_DIASTOLIC_2' 
...
WHERE SOURCE_DESCRIPTION = 'EMIS GP' AND 
B.CLUSTER_ID = 'HTN_SYSTOLIC_1' AND 
L.CLUSTER_ID = 'HTN_AMBULATORY_SYSTOLIC' 
...
WHERE SOURCE_DESCRIPTION = 'EMIS GP' AND 
B.CLUSTER_ID = 'HTN_DIASTOLIC_1' AND 
L.CLUSTER_ID = 'HTN_AMBULATORY_DIASTOLIC' 
